...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        # Create the labels to display the file sizes
        self.total_size_label = tk.Label(self, text="Total size of all files: ")
        self.image_size_label = tk.Label(self, text="Size of image files: ")
        self.video_size_label = tk.Label(self, text="Size of video files: ")
        self.audio_size_label = tk.Label(self, text="Size of audio files: ")
        self.text_size_label = tk.Label(self, text="Size of text files: ")

        # Create the labels to display the relative values
        self.image_relative_value_label = tk.Label(self, text="Image: ")
        self.video_relative_value_label = tk.Label(self, text="Video: ")
        self.audio_relative_value_label = tk.Label(self, text="Audio: ")
        self.text_relative_value_label = tk.Label(self, text="Text: ")

        # Create the label to display the Huffman codes
        self.huffman_code_label = tk.Label(self, text="Huffman codes: ")

        # Create the button to start the program
        ...
        self.video_size_label.pack()
        self.audio_size_label.pack()
        self.text_size_label.pack()
        self.image_relative_value_label.pack()
        self.video_relative_value_label.pack()
        self.audio_relative_value_label.pack()
        self.text_relative_value_label.pack()
        self.huffman_code_label.pack()
